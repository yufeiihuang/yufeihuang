...
export default function MapAtmosphere() {
  return <div className="map-atmosphere" aria-hidden="true">
    {[[32, 69, 0], [73, 31, 3], [90, 64, 5]].map(([x, y, delay], index) =>
      <svg key={`boat-${index}`} className="drifting-boat" viewBox="0 0 32 32" shapeRendering="crispEdges"
    ...
    <div className="mountain-snow">{SNOW.map(([x, y, delay], index) => <span key={`snow-${index}`} className="mountain-snowflake"
